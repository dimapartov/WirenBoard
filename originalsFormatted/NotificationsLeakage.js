defineRule("leakageNotification", {
    whenChanged: ["Leakage sensor-1 (стиральная машина)/water_leak", "Leakage sensor-2 (кухня, тумба)/water_leak",
        "Leakage sensor-3 (кухня, посудомойка)/water_leak", "Leakage sensor-4 (душевая, поддон)/water_leak",
        "wb-mwac_203/F1", "Leakage sensor-5 (детская, кондиционер)/water_leak", "Leakage sensor-6 (aux, кондиционер)/water_leak", "Leakage sensor-7 (спальня, кондиционер)/water_leak",
        "Leakage sensor-8 (БСУ, ниша)/water_leak", "Leakage sensor-9 (МСУ, пол)/water_leak", "Leakage sensor-10 (Daikin AC - Room4-MSU)/water_leak", "Leakage sensor-11 (МСУ, ниша)/water_leak"],
